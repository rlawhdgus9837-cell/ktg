...
def inject_global_style() -> None:
    st.markdown(
        ...
        .app-title { font-size: 1.9rem; font-weight: 800; letter-spacing: -0.04em; color: #3578c8; }
        ...
        .process-item b { display: block; color: #3578c8; margin-bottom: .2rem; }
        .soft-card {
        ...
        .money { font-size: 1.45rem; font-weight: 800; color: #3578c8; }
        ...
        .status-step.done { background: #edf5ff; border-color: #bfd8f2; color: #3578c8; }
        .status-step.current { background: #4f8ed8; border-color: #4f8ed8; color: #fff; font-weight: 700; }
        .stButton > button, .stDownloadButton > button {
            border-radius: 9px; min-height: 2.75rem; font-weight: 700;
            border: 1px solid #4f8ed8; background: #4f8ed8; color: #fff !important;
        ...
        .stButton > button:hover, .stDownloadButton > button:hover {
            border-color: #397dcc; background: #397dcc; color: #fff;
        }
...
def render_public_home() -> None:
    ...
    if st.session_state.show_order_auth:
        ...
        if st.session_state.get("auth_alert"):
            st.error(st.session_state.auth_alert)
            st.session_state.auth_alert = ""
